...
<template>
    ...
    <div class="flex justify-center w-full">
        <div class="max-w-md w-full flex flex-col min-h-screen bg-white">
            <!-- header -->
            <div class="flex flex-col pt-4 sticky top-0 z-10 bg-white ">
                <div class="px-4">
            ...
            >
                <div v-if="expiringPoint.length > 0 " class="p-3 bg-[#FDFBED] rounded-[5px] flex flex-col gap-1">
                    ...
                    <div class="text-[#3E200A] text-xs ">
                        <div v-for="(item, index) in expiringPoint" :key="index">
                            <span class="font-bold">{{ item.total.toFixed(2) }} pts</span> on <span class="">{{ formatDate2(item.date) }}</span>
                        </div>
                    </div>
                </div>
                <div class="sticky top-[177px] py-3 bg-white">
                ...
                <div class="flex flex-col gap-3 min-h-[80vh]">
